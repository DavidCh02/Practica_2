...
class PersonaModel<T extends Persona_1 = Persona_1> extends ObjectModel_1<T> {
    ...
    get usario(): StringModel_1 {
        return this[_getPropertyModel_1]("usario", (parent, key) => new StringModel_1(parent, key, true, { meta: { javaType: "java.lang.String" } }));
    }
    get edad(): NumberModel_1 {
        return this[_getPropertyModel_1]("edad", (parent, key) => new NumberModel_1(parent, key, false, { meta: { javaType: "int" } }));
    }
}
